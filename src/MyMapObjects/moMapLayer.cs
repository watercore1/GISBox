...
namespace MyMapObjects
{
    ...
    public class moMapLayer
    {
        ...
        public moMapLayer(string name, string path, moGeometryTypeConstant shapeType)
        {
            _Name = name;
            Path = path;
        ...
        public moMapLayer(string name, string path, moGeometryTypeConstant shapeTpye, moFields attributes)
        {
            _Name = name;
            Path = path;
            _ShapeType = shapeTpye;
            _AttributeFields = attributes;
            Initialize();
        }
