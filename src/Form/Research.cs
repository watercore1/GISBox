    ...
    public partial class Research : Form
    {
        ...
        public void Load_datatable()
        {
            ...
            for (int i = 0; i < layer_temp.AttributeFields.Count; i++)
            {
                ...
                {
                    dataTable.Columns.Add(layer_temp.AttributeFields.GetItem(i).Name, typeof(short));
                }
                else if (layer_temp.AttributeFields.GetItem(i).ValueType == MyMapObjects.moValueTypeConstant.dInt32)
                {
                    dataTable.Columns.Add(layer_temp.AttributeFields.GetItem(i).Name, typeof(int));
                }
                else if (layer_temp.AttributeFields.GetItem(i).ValueType == MyMapObjects.moValueTypeConstant.dInt64)
                {
                    dataTable.Columns.Add(layer_temp.AttributeFields.GetItem(i).Name, typeof(long));
                }
                else if (layer_temp.AttributeFields.GetItem(i).ValueType == MyMapObjects.moValueTypeConstant.dSingle)
                {
                    dataTable.Columns.Add(layer_temp.AttributeFields.GetItem(i).Name, typeof(float));
                }
